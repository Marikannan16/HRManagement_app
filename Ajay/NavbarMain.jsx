    ...
    return (
        <div className="bg-white shadow-lg text-white py-2 px-3 flex items-center justify-between">
            ...
            <div className="flex gap-2">
                <FaRegBell className='cursor-pointer text-3xl rounded-full bg-yellow-500 p-1' />
                <FaRegUserCircle className='cursor-pointer text-3xl rounded-full bg-yellow-500 p-1' />
            </div>
        </div>
    );
}
