...
import dbase from './Catdata';
import columns  from './Scol'; 
    ...
    <div>
      ...
      <div className='flex justify-items-stretch'>
            ...
            <div className='flex m-5 justify-start -space-x-10' >
                ...
                <input type='text' className='m-5 focus-visible focus-visible:outline-none  mt-2 mr-5 bg-gray-100 border text-md text-black border-gray-300  px-6 py-2 rounded-md ' placeholder='Search' onChange={(e) => setSearch(e.target.value)} ></input>
            ...
            <div className='flex justify-center mt-10 gap-5'>
                ...
                <button className='py-2 w-36 rounded-md text-white' style={{ backgroundColor: '#D7B95F' }}>Save</button>
            </div>
    </div>  
  )
}
