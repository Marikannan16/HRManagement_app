...
const Dropdown = ({ onFilterChange, startDate, setStartDate, onDownloadClick }) => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 mt-4 mb-4 ">
      <select className="p-2 border border-bordergray rounded-lg focus:outline-none w-full sm:w-32" value={filters.company} onChange={(e) => handleFilterChange('company', e.target.value)}>
      ...
      <select className="p-2 border border-bordergray rounded-lg focus:outline-none  w-full sm:w-32" value={filters.state} onChange={(e) => handleFilterChange('state', e.target.value)}>
        <option value="">State</option>
        <option value="Tamilnadu">Tamilnadu</option>
        <option value="Mumbai">Mumbai</option>
      </select>

      <select className="p-2 border border-bordergray rounded-lg focus:outline-none   w-full sm:w-32" value={filters.branch} onChange={(e) => handleFilterChange('branch', e.target.value)}>
      ...
      <select className="p-2 border border-bordergray rounded-lg focus:outline-none   w-full sm:w-32" value={filters.area} onChange={(e) => handleFilterChange('area', e.target.value)}>
        <option value="">Area</option>
        <option value="Area1">Area 1</option>
        <option value="Area2">Area 2</option>
      </select>

      <select className="p-2 border border-bordergray rounded-lg focus:outline-none   w-full sm:w-32" value={filters.username} onChange={(e) => handleFilterChange('username', e.target.value)}>
        <option value="">User Name</option>
        <option value="username 1">Username 1</option>
        <option value="username 2">Username 2</option>
      </select>

      <select className="p-2 border border-bordergray rounded-lg focus:outline-none   w-full sm:w-40" value={filters.compliancetype} onChange={(e) => handleFilterChange('compliancetype', e.target.value)}>
      ...
      <select className="p-2 border border-bordergray rounded-lg focus:outline-none   w-full sm:w-32" value={filters.priority} onChange={(e) => handleFilterChange('priority', e.target.value)}>
