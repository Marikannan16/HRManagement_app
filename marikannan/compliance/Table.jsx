...
const [search,setSearch]=useState("")
  ...
  return (
    <div className='w-screen h-screen px-10 py-5 '>
      ...
      <DataTable columns={columns} data={filterData} pagination selectableRows fixedHeader responsive highlightOnHover customStyles={customStyles} className='table-auto'/>  <br/><br/>
      </div>
